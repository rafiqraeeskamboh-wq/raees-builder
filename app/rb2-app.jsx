...
function RaeesBuilderApp() {
  ...
  function handleRoleChange(r) {
    if (r === "accountant") { var sec0 = rbGet("security", {}); var unlocked0 = rbGet("pin:accountant", false); if (sec0.userPin && !unlocked0) { setPinModalOpen(true); return; } } setRole(r);
  ...
  if (tab === "sale") {
    ...
    body = <SettingsTab t={t} lang={lang} role={role} onLang={setLang} onRole={handleRoleChange} permissions={permissions} onTogglePermission={togglePermission}
      onClear={clearAllData} activityLog={activityLog} security={security} onSetUserPin={setUserPin} onSetAdminPin={setAdminPin} />;
  }

  if (gateOpen) { return (<StartupPinGate onSubmit={confirmStartupPin} />); }
  ...
  return (
    <div dir={dir} style={{ background: TC.appBg, minHeight: "100vh", fontFamily: "Inter, system-ui, sans-serif" }}>
      ...
      {pinModalOpen ? (<UserPinModal onSubmit={confirmUserPin} onCancel={function () { setPinModalOpen(false); }} />) : null}{returnFor ? (
